...
* **Dynamic resource allocation**:
  ...
  * The number of iterations for making progress can be tracked with methods such as [semantic entropy](https://github.com/jlko/semantic_uncertainty). That is, if the *differences* between responses are no longer significant, the algorithm could set to finish early.
* **Semantic filters**:
  * The centralized aggregator could potentially be assigned the role of filtering *bad* responses.
  ...
  * Similar routing works used for predicting the best-performing model from a fixed set of LLMs, for a given input include: [arXiv:2311.08692](https://arxiv.org/abs/2311.08692) or [arXiv:2309:15789](https://arxiv.org/pdf/2309.15789).
